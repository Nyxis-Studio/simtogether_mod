...
from smp4.utils.native.decorator import decorator
from sims4 import core_services
from smp4.core.mp_sync import outgoing_lock, outgoing_commands, client_sync, server_sync
...
from smp4.utils.native.undecorated import undecorated
...
def on_tick_client():
    ...
    smp4.core.mp_sync.client_online = False
    ...
    if client is None:
        return
    smp4.core.mp_sync.client_online = True
